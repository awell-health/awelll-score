...
import { PAID20_INPUTS, PAID_20_INTERPRATION } from './definition'
...
describe.only('paid_20', function () {
  ...
  describe('score calculation', function () {
    describe('when called with the best response', function () {
      ...
      it('should return the "Not severe diabetes distress" interpretation', function () {
        ...
        expect(score).to.eql(PAID_20_INTERPRATION.NOT_SEVERE)
      })
    ...
    describe('when called with the worst response', function () {
      ...
      it('should return the "Severe diabetes distress" interpretation', function () {
        ...
        expect(score).to.eql(PAID_20_INTERPRATION.SEVERE)
      })
